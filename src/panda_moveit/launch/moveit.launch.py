...
def generate_launch_description():
    ...
    moveit_config = (
        ...
        .planning_pipelines(pipelines=["ompl", "chomp", "pilz_industrial_motion_planner"]) # Explicitly list them
        .trajectory_execution(file_path="config/moveit_controllers.yaml")
        .moveit_cpp(file_path=os.path.join(get_package_share_directory("panda_moveit"), "config", "moveit_controllers.yaml"))
        .to_moveit_configs()
    )
    ...
    move_group_node = Node(
        ...
        parameters=[
            ...
            {"planning_scene_monitor.start_state_max_bounds_error": 0.01}
        ],
