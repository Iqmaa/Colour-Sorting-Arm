...
class ColorDetector(Node):
    def __init__(self):
        ...
        # Subscriber
        self.image_sub = self.create_subscription(  #subscrbes to camera feed
            Image, '/camera/image_raw', self.image_callback, 10)

        # Publisher that sends out a string that contains the color name and x,y,z coordinates
        ...
        # TF2 setup
        self.tf_buffer = tf2_ros.Buffer() #listener that tracks position of every part of the robot
        self.tf_listener = tf2_ros.TransformListener(self.tf_buffer, self)

        # Camera intrinsic parameters (from your SDF)
        #tells the code how to interprete 2d pixels to 3d angles 
        self.fx = 585.0
        self.fy = 588.0
        self.cx = 320.0
        self.cy = 160.0
    ...
    def image_callback(self, msg):
        try:
            # Convert ROS Image to a BGR for OpenCV to understand
        ...
        # Define color ranges (HSV- hue,saturation,value) which is better for color detection
        color_ranges = {
